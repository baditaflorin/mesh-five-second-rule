# mesh-five-second-rule

[![pages](https://img.shields.io/badge/live-baditaflorin.github.io%2Fmesh-five-second-rule-ea580c)](https://baditaflorin.github.io/mesh-five-second-rule/)
[![version](https://img.shields.io/badge/version-0.1.0-blue)](https://github.com/baditaflorin/mesh-five-second-rule/blob/main/package.json)
[![license](https://img.shields.io/badge/license-MIT-green)](./LICENSE)

> A fast, peer-to-peer answer game where every voice gets five seconds.

**Live → https://baditaflorin.github.io/mesh-five-second-rule/**

**Source → https://github.com/baditaflorin/mesh-five-second-rule**
...
1. Open the same room on two or more devices and set a display name.
2. The shared roster and mesh clock select a player and prompt every five seconds.
3. The active player says three answers out loud, then marks the round complete.
4. Everyone else can send a small cheer. The prompt and turn advance automatically.

Turns, prompt selection, completion marks, and reactions are derived or stored
in the room's Yjs document. There is no game server and no room owner.
...
git clone https://github.com/baditaflorin/mesh-five-second-rule
cd mesh-five-second-rule
npm install
npm run dev
```
...
- `mesh-five-second-rule:signalingUrl`
- `mesh-five-second-rule:turnTokenUrl`
- `mesh-five-second-rule:iceServers`
- `mesh-five-second-rule:room`
